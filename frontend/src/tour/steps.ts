...
export const proTour: TourStep[] = [
  ...
  { id: "question.settings", page: "question", target: "question.settings", kind: "info",
    ...
    bodyKey: "Random order shows the answers shuffled per participant. ‘Reveal correct answer’ decides whether the solution appears immediately with the results, only when triggered, or never." },
