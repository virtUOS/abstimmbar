...
export const proTour: TourStep[] = [
  ...
  { id: "question.settings", page: "question", target: "question.settings", kind: "info",
    ...
    bodyKey: "Random order shows the answers shuffled per participant. ‘Reveal correct answer’ decides whether the solution appears with the results, after closing, or never." },
  ...
  q("priorities", "Priorities", "Participants distribute 100 points across the answers — the more important, the more points. The result shows which items received the highest priority overall."),
  ...
  { id: "present.controls", page: "present", target: "present.controls", kind: "info",
    ...
    bodyKey: "The flow: Start (S) opens the question, Stop closes it, Results (E) shows or reveals the answers, → moves to the next question, End (Esc) closes the run and stores the results." },
