  ...
  return (
    <select
      ...
      className={
        ...
        "text-slate-700 focus:outline-none focus:ring-4 focus:ring-brand-600 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-slate-950 " +
